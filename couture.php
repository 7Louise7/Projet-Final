...
//page de présentation de la catégorie couture
...
//on cherche à savoir quel abonnement possède l'utilisateur 
		...
		$req->closeCursor();
//s'il a un abonnement standard, on affiche que les tutos standards qui ont pour thème couture
		if ($idabonnement['idabonnement'] == 1) {
			$req = $bdd->query("SELECT tuto.idtuto, titreTuto, chemin FROM tuto, photo where theme='couture' AND tuto.idtuto=photo.idtuto and tuto.idabonnement=1");
			$compteur = 1;
...
//sinon, on affiche tous les tutos qui ont pour thème coututre  (comme il a un abonnement premium)
		else {
